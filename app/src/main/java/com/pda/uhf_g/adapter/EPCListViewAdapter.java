...
public class EPCListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            viewHolder.layoutSgtin = (LinearLayout) convertView.findViewById(R.id.layout_Sgtin);
            viewHolder.tvTid = (TextView) convertView.findViewById(R.id.tv_tid) ;
            viewHolder.tv_sgtin = (TextView) convertView.findViewById(R.id.tv_sgtin) ;
        ...
        if (list != null && !list.isEmpty()) {
            ...
            //viewHolder.layoutSgtin.setVisibility(View.VISIBLE);
            //viewHolder.tv_sgtin.setText(tag.getSgtin());
            if (tag.getIsShowTid()) {
