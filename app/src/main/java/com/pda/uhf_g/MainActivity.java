...
public class MainActivity extends AppCompatActivity implements NavigationView. OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setTheme(R.style.Theme_UHFG_splash);
    ...
    private void initModule() {
        ...
        if(mUhfrManager!=null){
            ...
            if(err== Reader.READER_ERR.MT_OK_ERR){
                ...
                Toast.makeText(getApplicationContext(),"Região:"+Reader.Region_Conf.valueOf(sharedUtil.getWorkFreq())+
                        "\n"+"Potência de leitura:"+sharedUtil.getPower()+
                        "\n"+"Potência de escrita:"+sharedUtil.getPower(),Toast.LENGTH_LONG).show();
                ...
                if(err1== Reader.READER_ERR.MT_OK_ERR) {
                    ...
                    Toast.makeText(getApplicationContext(), "Região:" + Reader.Region_Conf.valueOf(mSharedPreferences.getInt("freRegion", 1)) +
                            "\n" + "Potência de leitura:" + 30 +
                            "\n" + "Potência de escrita:" + 30, Toast.LENGTH_LONG).show();
                }else {
